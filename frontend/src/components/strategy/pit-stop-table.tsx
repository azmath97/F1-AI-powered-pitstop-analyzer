...
export function PitStopTable({ pitStops, season = 2026 }: { pitStops: PitStopSummary[]; season?: number }) {
  return (
    <section className="border border-border bg-[#111418]">
      ...
      {pitStops.map((stop) => (
        <div
          ...
          className="grid grid-cols-[0.45fr_0.4fr_0.4fr_0.7fr_0.7fr_0.8fr_0.8fr] border-b border-border px-3 py-2 text-sm last:border-b-0"
        >
